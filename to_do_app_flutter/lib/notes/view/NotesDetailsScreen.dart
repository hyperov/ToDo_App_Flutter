...
class NotesDetailsWidget extends StatelessWidget {
  ...
  final SharedViewModel _sharedViewModel = Get.find();
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () {
        ever(
          _sharedViewModel.selectedNote,
              (callback) {
            detailsController.titleController.text =
                _sharedViewModel.selectedNote.value?.title ?? "";
            detailsController.descController.text =
                _sharedViewModel.selectedNote.value?.desc ?? "";
          },
        );
        return Scaffold(
